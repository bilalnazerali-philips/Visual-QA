...
public sealed class MetadataAliasesOptions { public bool Enabled { get; init; } public IReadOnlyDictionary<string,string> FontFamily { get; init; } = new Dictionary<string,string>(StringComparer.Ordinal); }
